                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">{BlogDetails.author}</Link> </li>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">Planning</Link></li>
                                        <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">Architecture</Link></li>
                                        <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">creative</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">facebook</Link></li>
                                        <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">twitter</Link></li>
                                        <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">linkedin</Link></li>
                                        <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1" className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1"><i className="ti-facebook"></i></Link></li>
                                            <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1"><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1"><i className="ti-linkedin"></i></Link></li>
                                            <li><Link to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1"><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link className="comment-reply-link" to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1"><span>Reply</span></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

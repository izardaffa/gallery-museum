                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 custom-grid">
                                                    <div className="progress blue">
                                                        ...
                                                        <div className="progress-name"><span>Empires</span></div>
                                                    </div>
                                                </div>
                                                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 custom-grid">
                                                    <div className="progress pink">
                                                        ...
                                                        <div className="progress-name"><span>Technology</span></div>
                                                    </div>
                                                </div>
                                                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 custom-grid">
                                                    <div className="progress green">
                                                        ...
                                                        <div className="progress-name"><span>Politics</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

...
class Header extends Component<{}, HeaderState> {
    ...
    componentDidMount() {
        ...
        (window as any).updateTopMostParent = (logopath: string) => {
                        ...
                        <div className="container">
                            <div className="d-flex justify-content-between">
                                <ul className="list-unstyled e-p-bx text-white">
                                    ...
                                    <li>
                                        <span>Call us:</span>(075) 123-7654
                                    </li>
                                </ul>
                                <ul className="list-unstyled social-bx d-flex align-content-center flex-wrap text-white">
                                    <li>
                                        <a

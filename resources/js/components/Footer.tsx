...
import fBg from './../assets/images/background/f-bg.jpg';
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <div className="widget widget_about">
                                        ...
                                        <p>
                                            7X Theme is a html template for
                                            interior and architecture purpose.
                                            Today we can tell you, thanks to
                                            your passion.
                                        </p>
                                    ...
                                    <div className="widget recent-posts-entry-date">
                                        ...
                                        <div className="widget-post-bx">
                                            <div className="widget-post clearfix">
                                                <div className="sx-post-date text-uppercase text-center text-white">
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <div className="widget widget_address_outer">
                                        ...
                                        <ul className="widget_address">
                                            <li>
                                                756 Livingston Street, Brooklyn,
                                                NY 11201, United State
                                            </li>
                                ...
                                <div className="row">
                                    <div className="col-lg-7 col-md-6">
                                        <div className="call-to-action-left">
                                            ...
                                            <span>
                                                Never Miss Anything From 7xtheme
